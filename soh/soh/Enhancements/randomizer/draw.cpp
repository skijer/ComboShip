...
// MM item; the resolve chain, the per-MM-draw-func handlers and the draw itself are combo-owned
// (combo/menu/ComboForeignDrawOOT.h — the mirror of MM's ComboForeignDrawMM.h). TU-glue: needs the
// engine headers and ComboForeignAnim.h above already in scope.
#include "ComboForeignDrawOOT.h"
