...
#pragma region Vanilla
    ...
    areaTable[RR_SPIRIT_TEMPLE_FOYER] = Region("Spirit Temple Foyer", SCENE_SPIRIT_TEMPLE, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_ADULT_SIDE_HUB,  logic->HasStrength(2)),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_RUPEE_BRIDGE_NORTH] = Region("Spirit Temple Rupee Bridge North", SCENE_SPIRIT_TEMPLE, {
        ...
        EVENT_ACCESS(LOGIC_SPIRIT_SILVER_RUPEE_BRIDGE_TORCHES, (logic->Get(LOGIC_SPIRIT_SILVER_RUPEE_BRIDGE) && logic->HasFireSourceWithTorch()) || (logic->HasMagicFire())),
    }, {
        //Locations
    ...
    areaTable[RR_SPIRIT_TEMPLE_SUN_ON_FLOOR_2F] = Region("Spirit Temple Sun On Floor 2F", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_STATUE_ROOM_CHILD, logic->HasExplosives() || ((ctx->GetOption(RSK_SUNLIGHT_ARROWS) && (logic->HasLightSource())) || logic->CanUse(RG_LIGHT_ROD))),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_INNER_WEST_HAND] = Region("Spirit Temple Inner West Hand", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        //Exits
        ENTRANCE(RR_DESERT_COLOSSUS, (logic->IsChild && logic->SmallKeys(SCENE_SPIRIT_TEMPLE, 5)) || (logic->HasStrength(2) && ((logic->SmallKeys(SCENE_SPIRIT_TEMPLE, 3) && logic->HasExplosives()) || logic->SmallKeys(SCENE_SPIRIT_TEMPLE, 5)))),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_STATUE_ROOM] = Region("Spirit Temple Statue Room", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_ADULT_SIDE_HUB,    ctx->GetOption(RSK_SHUFFLE_DUNGEON_ENTRANCES).Is(RO_DUNGEON_ENTRANCE_SHUFFLE_OFF) &&
                                                     logic->HasStrength(2) && logic->IsAdult &&
    ...
    areaTable[RR_SPIRIT_TEMPLE_SHORTCUT] = Region("Spirit Temple Shortcut", SCENE_SPIRIT_TEMPLE, {}, {}, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_STATUE_ROOM, true),
        ENTRANCE(RR_SPIRIT_TEMPLE_FOYER,       logic->HasStrength(2) && logic->CanUse(RG_MEGATON_HAMMER)),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_4_ARMOS] = Region("Spirit Temple 4 Armos", SCENE_SPIRIT_TEMPLE, {}, {
        //Locations
        LOCATION(RC_SPIRIT_TEMPLE_NEAR_FOUR_ARMOS_CHEST, ((logic->CanReflectLight()) || logic->SunlightArrows()) && logic->HasExplosives() && logic->HasItem(RG_OPEN_CHEST)),
        LOCATION(RC_SPIRIT_TEMPLE_ARMOS_ROOM_SUN_FAIRY,  logic->HasExplosives() && logic->CanUse(RG_SUNS_SONG)),
    }, {
        ENTRANCE(RR_SPIRIT_TEMPLE_BEAMOS_PITS,       true),
        ENTRANCE(RR_SPIRIT_TEMPLE_4_ARMOS_SIDE_ROOM, (logic->CanReflectLight()) || logic->SunlightArrows()),
    ...
    areaTable[RR_SPIRIT_TEMPLE_BIG_MIRROR_ROOM] = Region("Spirit Temple Big Mirror Room", SCENE_SPIRIT_TEMPLE, {
        ...
        EVENT_ACCESS(LOGIC_SPIRIT_PLATFORM_LOWERED, (logic->Get(LOGIC_SPIRIT_PUSHED_4F_MIRRORS) && (logic->CanReflectLight())) || logic->SunlightArrows()),
    ...
    areaTable[RR_SPIRIT_TEMPLE_BIG_MIRROR_CAVE] = Region("Spirit Temple Big Mirror Cave", SCENE_SPIRIT_TEMPLE, {
        ...
        //Locations
        LOCATION(RC_SPIRIT_TEMPLE_TOPMOST_CHEST, ((logic->IsAdult && (logic->CanReflectLight())) || logic->SunlightArrows()) && logic->HasItem(RG_OPEN_CHEST)),
    }, {
        //Exits
        ENTRANCE(RR_SPIRIT_TEMPLE_BIG_MIRROR_ROOM, true),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_PLATFORM] = Region("Spirit Temple Lowered Platform", SCENE_SPIRIT_TEMPLE, {}, {}, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_STATUE_ROOM_ADULT, true),
        ENTRANCE(RR_SPIRIT_TEMPLE_INNER_LEFT_HAND,   true),
        ENTRANCE(RR_SPIRIT_TEMPLE_STATUE_HEAD,       logic->Get(LOGIC_SPIRIT_PUSHED_4F_MIRRORS) && (logic->CanReflectLight()) && logic->CanUse(RG_HOOKSHOT)),
    });
...
#pragma region MQ
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_FOYER] = Region("Spirit Temple MQ Foyer", SCENE_SPIRIT_TEMPLE, {
        ...
        LOCATION(RC_SPIRIT_TEMPLE_MQ_ENTRANCE_BOULDER_1,         logic->CanBreakBoulder()),
        LOCATION(RC_SPIRIT_TEMPLE_MQ_ENTRANCE_BOULDER_2,         logic->CanBreakBoulder()),
        LOCATION(RC_SPIRIT_TEMPLE_MQ_ENTRANCE_EYE_BOULDER,       logic->CanBreakBoulder()),
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_GIBDO_GRAVES] = Region("Spirit Temple MQ Gibdo Graves", SCENE_SPIRIT_TEMPLE, {
        ...
        //Location
        LOCATION(RC_SPIRIT_TEMPLE_MQ_GIBDO_BOULDER_HIGH, logic->CanBreakBoulder()),
        LOCATION(RC_SPIRIT_TEMPLE_MQ_GIBDO_BOULDER_LOW,  logic->CanBreakBoulder()),
    }, {
        //Exits
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_GIBDO_POTS] = Region("Spirit Temple MQ Gibdo Pots", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        LOCATION(RC_SPIRIT_TEMPLE_MQ_GIBDO_BOULDER,     logic->CanBreakBoulder()),
    }, {
        //Exits
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_STATUE_ROOM] = Region("Spirit Temple MQ Statue Room", SCENE_SPIRIT_TEMPLE, {
        ...
        EVENT_ACCESS(LOGIC_SPIRIT_MQ_STATUE_ROOM_TORCHES, (logic->HasFireProjectile()) || (ctx->GetTrickOption(RT_SPIRIT_MQ_LOWER_ADULT) && (logic->HasMagicFire()))),
    }, {
        //Locations
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_BIG_BLOCKS_HOLE] = Region("Spirit Temple MQ Big Blocks Hole", SCENE_SPIRIT_TEMPLE, {}, {}, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_BIG_BLOCKS_DOOR, logic->IsChild ? logic->HasStrength(2) : AnyAgeTime([]{return logic->HasStrength(2);})),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_3_SUNS_ROOM_2F] = Region("Spirit Temple MQ Three Suns Room 2F", SCENE_SPIRIT_TEMPLE, {
        ...
        EVENT_ACCESS(LOGIC_SPIRIT_MQ_3SUNS_ENEMIES, ((logic->CanReflectLight()) && logic->CanKillEnemy(RE_STALFOS, ED_CLOSE, true, 2)) || logic->SunlightArrows()),
    }, {}, {
        //Exits
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_BEHIND_GEYSER] = Region("Spirit Temple MQ Behind Geyser", SCENE_SPIRIT_TEMPLE, {
        ...
        LOCATION(RC_SPIRIT_TEMPLE_MQ_EARLY_ADULT_BOULDER, logic->CanBreakBoulder()),
    }, {
        //Exits
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_SOT_SUN_ROOM] = Region("Spirit Temple MQ SoT Sun Room", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_3F_GIBDO_ROOM,      AnyAgeTime([]{return ((logic->IsAdult || logic->CanUse(RG_SONG_OF_TIME)) && (logic->CanReflectLight())) || logic->SunlightArrows();})),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_BIG_MIRROR_CAVE] = Region("Spirit Temple MQ Big Mirror Cave", SCENE_SPIRIT_TEMPLE, {
        //Events
        EVENT_ACCESS(LOGIC_SPIRIT_PUSHED_4F_MIRRORS, ((logic->IsAdult && (logic->CanReflectLight())) || logic->SunlightArrows() || (ctx->GetTrickOption(RT_FIRE_RINGS) && logic->TakeDamage())) && logic->HasItem(RG_POWER_BRACELET)),
    }, {
        //Locations
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_PLATFORM] = Region("Spirit Temple MQ Platform", SCENE_SPIRIT_TEMPLE, {}, {}, {
        //Exits
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_STATUE_HEAD,       logic->Get(LOGIC_SPIRIT_PUSHED_4F_MIRRORS) && (logic->CanReflectLight()) && logic->CanUse(RG_HOOKSHOT)),
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_STATUE_ROOM_CHILD, true),
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_INNER_RIGHT_HAND,  true),
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_STATUE_ROOM,       true),
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_STATUE_ROOM_ADULT, true),
