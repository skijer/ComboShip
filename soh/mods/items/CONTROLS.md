# Not Enough Items — Controls (ComboShip, OoT side)

Source of truth for every in-game control string: the get-item textboxes
(`soh/mods/extended_player.c` `sNeiItems[]`, `soh/soh/Enhancements/randomizer/randomizer.cpp`
...
code wins and the strings get fixed. Kept in step with the Shipwright copy of this file; the MM
side is `mm/mods/items/CONTROLS.md`.
...
| | *(Insect Glaive)* | Forward + B | Thrust |
| | | Hold B | Quick spin |
| | | Z + A | Jump slash |
